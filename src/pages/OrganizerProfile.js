                  ...
                  <div class="">
                    <ul class="nav nav-pills ff-tablist mb-2" role="tablist">
                      <li class="nav-item d-flex me-4">
                        <a
                          class="nav-link px-0 pt-0 pb-3 active"
                          ...
                          aria-selected="true"
                        >
                          Following <span class="following_count">(2)</span>
                        </a>
                      </li>
                      <li class="nav-item d-flex">
                        <a
                          class="nav-link px-0 pt-0 pb-3"
                        ...
                        <div class="users-list min-height-430">
                          <div class="user-follow-card mb-4">
                            <div class="follow-card-left">
                              <div class="follow-avatar">
                                <img
                                  src="images/profile-imgs/img-2.jpg"
                                  alt=""
                                />
                              </div>
                          ...
                          <div class="user-follow-card mb-4">
                            <div class="follow-card-left">
                              <div class="follow-avatar">
                                <img
                                  src="images/profile-imgs/img-1.jpg"
                                  alt=""
                                />
                              </div>
                              <div class="follow-name">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="cover-img-btn">
                        ...
                        <label for="cover-img">
                          <i class="fa-solid fa-panorama me-3"></i>Change Image
                        </label>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="main-card user-left-dt">
                      ...
                      <div class="user-btns">
                        <a
                          ...
                          class="co-main-btn co-btn-width min-width d-inline-block h_40"
                        >
                          My Organisation
                          <i class="fa-solid fa-right-left ms-3"></i>
                        </a>
                      </div>
                  ...
                  <div class="col-xl-8 col-lg-7 col-md-12">
                    <div class="right-profile">
                      <div class="profile-tabs">
                        <ul
                          class="nav nav-pills nav-fill p-2 garren-line-tab"
                          id="myTab"
                          role="tablist"
                        >
                          <li class="nav-item">
                                    ...
                                    <div class="main-card mt-4">
                                      <div class="card-top p-4">
                                        <div class="card-event-img">
                                          <img
                                            src="images/event-imgs/img-6.jpg"
                                            alt=""
                                          />
                                        </div>
                          ...
                          >
                            <div class="main-card mt-4">
                              ...
                              <div class="about-details">
                                ...
                                <div class="about-step">
                                  <h5>
                                    Tell us about yourself and let people know
                                    who you are
                                  </h5>
                                  <p class="mb-0">
                                    Lorem ipsum dolor sit amet, consectetur
                                    adipiscing elit. Ut tincidunt interdum nunc
                                    et auctor. Phasellus quis pharetra sapien.
                                    ...
                                    >
                                      ...
                                      <div class="profile-setting p-4">
                                        ...
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                            <h3 class="setting-title">
                                              Receive event invitations from
                                              event organisers sent to my email
                                              address
                                            </h3>
                                            <label class="btn-switch m-0 ml-2">
                                              <input
                                          ...
                                          <p class="mt-1 mb-4">
                                            Organisations will be able to send
                                            you Invitations in their events.
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                            <h3 class="setting-title">
                                              Receive reminder from Ticket Loop
                                              for my purchased events
                                            </h3>
                                            <label class="btn-switch m-0 ml-2">
                                              <input
                                                type="checkbox"
                                        ...
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                            <h3 class="setting-title">
                                              ...
                                              Ticket Loop service status and
                                              product updates
                                            </h3>
                                            <label class="btn-switch m-0 ml-2">
                                              <input
                                          ...
                                          <p class="mt-1 mb-4">
                                            ...
                                            insights so that you can make the
                                            best use of Ticket Loop .
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                            <h3 class="setting-title">
                                              Receive newsletters from Ticket
                                              Loop with general and other
                                              information
                                            </h3>
                                            <label class="btn-switch m-0 ml-2">
                                              <input
                                          ...
                                          <p class="mt-1 mb-4">
                                            Get more insights on Ticket Loop
                                            that can help to boost your event
                                            business.
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-4">
                                            We will notify you when someone
                                            starts following you or your
                                            organisation.
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                        ...
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-0">
                                            We will notify you when someone
                                            leaves review for your organisation.
                                          </p>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    >
                                      ...
                                      <div class="privacy-setting p-4">
                                        ...
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-4">
                                            People will be able to send you
                                            emails through Ticket Loop who
                                            visits your profile
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                        ...
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-4">
                                            ...
                                            have started using Ticket Loop
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-0">
                                            People will be able to see the
                                            events you have joined as Speaker
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          <div class="d-flex align-items-center justify-content-between">
                                          ...
                                          <p class="mt-1 mb-0">
                                            People will be able to see the
                                            events you have shared in Ticket
                                            Loop
                                          </p>
                                        </div>
                                        <div class="setting-step pt-4">
                                          ...
                                          <p class="mt-1 mb-0">
                                            ...
                                            will not appear in your public
                                            profile
                                          </p>
                                        </div>
                                      </div>
