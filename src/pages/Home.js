              ...
              <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-9 col-md-10">
                  <div class="hero-banner-content">
                    <h2>
                      TicketLoop is the easiest Online Event Booking and
                      Ticketing System
                    </h2>
                    <p>
                      Ticket Loop is an all-in-one event ticketing platform for
                      event organisers, promoters, and managers. Easily create,
                      promote and manage your events of any type and size.
                    </p>
                    <a href="/create-event" class="main-btn btn-hover">
            ...
            <div class="container">
              <div class="row">
                <div class="col-lg-10">
                  <div class="main-title">
                    <h3>
                      Host Engaging Online and Venue Events with TicketLoop
                    </h3>
                    <p>
                      Organise venue events and host online events with
                      ...
                      <div class="item">
                        <div class="main-card">
                          <div class="host-item">
                            ...
                            <h4>Webinar</h4>
                            <p>
                              Webinars tend to be one-way events. TicketLoop
          ...
          <div class="feature-block p-80">
            <div class="container">
              <div class="row">
                <div class="col-lg-10">
                  <div class="main-title">
                    <h3>Our Ticket Loop Features, Get Exactly What You Need</h3>
                    <p>
                      As well as being the most affordable online-based event
                      registration tool and one of the best online event
                      ticketing systems in Australia, TicketLoop is super
                      easy-to-use and built with a simplistic layout which is
                      totally convenient for the organisers to operate.
                    </p>
                  </div>
                </div>
                <div class="col-lg-12">
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane fade" id="step-03" role="tabpanel">
                        <div class="row">
                          <div class="col-lg-12 col-md-12">
                            <div class="step-text">
                              Use TicketLoop to host any types of online events
                              for free.
                            </div>
                          </div>
                          <div class="col-lg-4 col-md-6">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 col-md-6">
                            <div class="step-item">
                              ...
                              <p>
                                Our dedicated on-boarding coach will assist you
                ...
                <div class="col-lg-10">
                  <div class="main-title">
                    ...
                    <p>
                      ...
                      participate your in events. Here is what some of the
                      clients have to say,
                    </p>
                  </div>
                </div>
